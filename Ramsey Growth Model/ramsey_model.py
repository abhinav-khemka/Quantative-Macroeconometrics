"""
Growth Model Simulations (Ramsey Growth Models)
...
## Transition from steady state to new steady state
...
# Setting parAmeters at steady state
...
## Shock after 10 periods of steady state
...
##Introduction of capital tax in old steady state

# we assume tax is 4 % and v is assigned as the tax parameter
